...
e
$$\mathbb{E}\left[\frac{Z(h)^k}{Z_0^k}\right] = \exp\left\{ V\alpha \int_0^1 dy\,y \left[\sqrt{y^2 + k\left(\frac{\sigma}{(2\pi^2 \alpha)^{1/3}}\right)^2} - y\right]\ln\left[2\sinh\left(\frac{T_D}{2T}y\right)\right]\right\}$$
