...
$$Z(h) = \int [d\varphi] \exp{\left\{-\int_0^{\hslash \beta} d\tau \int_V d\mathbf{x} \Bigg[\frac{1}{2}\varphi(\tau, \x) \left(-\frac{1}{u^2}\frac{\partial^2}{\partial \tau^2} \right. \right.}- \Delta \Bigg)\varphi(\tau, \x) - h(\tau, \x)\varphi(\tau, \x)\Bigg]\Bigg\}$$
...
$$Z(0) = \exp\left\{ V\alpha\int_0^1 dy\,y^{2}\ln\bigg[2\sinh\bigg(\frac{T_D}{2T}y\bigg)\bigg]\right\}  $$

e
$$\mathbb{E}\left[\frac{Z(h)^{k}}{Z_0^k}\right] = \exp\left\{ V\alpha \int_0^1 dy\,y \left[\sqrt{y^2 + k\left(\frac{\sigma}{\left(2\pi^2 \alpha\right)^{1/3}}\right)^2} -y\right]\ln\bigg[2\sinh\bigg(\frac{T_D}{2T}y\bigg)\bigg]\right\} +$$
